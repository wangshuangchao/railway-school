...
<script>
	export default {
		...
		methods: {
			btnActionA() {
				this.btnAction1 = true
				this.btnAction2 = false
				this.$router.replace('/newsBulletin/schDynamic')
			},
			btnActionB() {
				this.btnAction1 = false
				this.btnAction2 = true
				this.$router.replace('/newsBulletin/schNews')
			}
		}
	}
</script>
